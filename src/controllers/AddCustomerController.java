...
public class AddCustomerController implements Initializable {
    ...
    public void addButtonClicked(ActionEvent actionEvent) throws SQLException, IOException {
        if (nameTextField.getText() == ""){PopUpBox.errorBox("The name field must be filled out to continue");}
            ...
            if (CustomerSQL.addCustomer(nameTextField.getText(), telephoneTextField.getText(), (String) divisionComboBox.getSelectionModel().getSelectedItem(), addressTextField.getText(), postalCodeField.getText())){
